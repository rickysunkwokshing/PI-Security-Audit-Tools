...
[Diagnostics.CodeAnalysis.SuppressMessageAttribute("PSAvoidUsingPlainTextForPassword", "", Justification="Cmdlets in this module are handling the filename, not the password.")]
param()
...
procedure.  For more information, see:<br/>
...
#>
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute("PSUseSingularNouns", "", Justification="The configuration option uses a plural noun.")]
    [Diagnostics.CodeAnalysis.SuppressMessageAttribute("PSAvoidUsingUserNameAndPassWordParams", "", Justification="Specifying a filename, not a password.")]
    [CmdletBinding(DefaultParameterSetName = "Default", SupportsShouldProcess = $false)]
    param(
        [parameter(Mandatory = $true, Position = 0, ParameterSetName = "Default")]
...
.DESCRIPTION
VALIDATION CHECK: Verifies that SQL Server does not have DB Mail XPs enabled.</br>
...
.DESCRIPTION
VALIDATION: Verifies that SQL Server does not have Remote Access enabled.<br/>
...
.DESCRIPTION
VALIDATION: Verifies that SQL Server does not have the sa login enabled.<br/>
